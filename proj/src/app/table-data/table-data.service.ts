...
export class Service {
  getDistricts() {
    this.getRegions();
    for (let j: number = 0; j < districts.length; j++) {
      let sum_adult_man: number = 0;
      let sum_child_man: number = 0;
      let sum_senior_man: number = 0;
      let sum_adult_woman: number = 0;
      let sum_child_woman: number = 0;
      let sum_senior_woman: number = 0;
